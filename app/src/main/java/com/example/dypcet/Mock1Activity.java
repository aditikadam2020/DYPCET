...
public class Mock1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Mock1Activity.this, CetMockActivity.class);
        ...
        cd_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (url != null)
                {
                    ...
                    Toast.makeText(Mock1Activity.this,"Something is wrong.. please choose press the button again..!!",Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void getMockTests() {
        FirebaseFirestore.getInstance().collection("mockTests").document("mockTest1").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
