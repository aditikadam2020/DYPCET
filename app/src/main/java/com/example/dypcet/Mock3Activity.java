...
public class Mock3Activity extends AppCompatActivity {
        ...
        cd_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (url != null)
                {
                    ...
                    Toast.makeText(Mock3Activity.this,"Something is wrong.. please choose press the button again..!!",Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void getMockTests() {
        FirebaseFirestore.getInstance().collection("mockTests").document("mockTest3").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
