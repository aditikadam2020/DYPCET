...
public class Mock2Activity extends AppCompatActivity {
    ImageView iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Mock2Activity.this, CetMockActivity.class);
        ...
        cd_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (url != null)
                {
                    ...
                    Toast.makeText(Mock2Activity.this,"Something is wrong.. please choose press the button again..!!",Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void getMockTests() {
        FirebaseFirestore.getInstance().collection("mockTests").document("mockTest2").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
