...
import com.dypcet.dypcet.databinding.ActivityDashBoardBinding;
...
public class DashBoardActivity extends AppCompatActivity {
    ...
    private void slider(){
        ...
        binding.carousel.addData(new CarouselItem("https://pbs.twimg.com/media/FIAFSboUUAA0V4w?format=jpg&name=large"));
        binding.carousel.addData(new CarouselItem("https://media.licdn.com/dms/image/C4D22AQFI6QeKL4l9Tg/feedshare-shrink_800/0/1662355596468?e=1682553600&v=beta&t=Tn2cVa_fV_JJjdyAE9e_t41b7lplcF1zc4QAk4AFPbI"));
        ...
        binding.carousel.addData(new CarouselItem("https://coek.dypgroup.edu.in/wp-content/uploads/2017/06/Interaction-1-scaled.jpg"));
        binding.carousel.addData(new CarouselItem("https://coek.dypgroup.edu.in/wp-content/uploads/2017/06/Candid-Placement-1-scaled.jpg"));
        binding.carousel.addData(new CarouselItem("https://coek.dypgroup.edu.in/wp-content/uploads/2017/10/traningmenu.jpg"));
    }
}